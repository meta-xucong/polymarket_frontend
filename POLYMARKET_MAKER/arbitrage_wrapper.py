...
def run_arbitrage_from_mapping(params: Dict[str, Any]) -> Dict[str, Any]:
    """Helper to execute the strategy from a dict-style payload."""

    cfg = build_run_config_from_mapping(params or {})
    return run_with_config(cfg)
